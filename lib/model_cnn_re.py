...
class CNNModel(Model):
    ...
    def load_vocab(self):
        vocab = Vocab('vocab', fn=self.config.vocab_fp)
    ...
    def predict(self, data_fp, dst_fp=None, verbose=100, has_label = False):
        ...
        loader = self.common['loader']
        data_txt, data_len, data_label = loader.load(data_fp, has_label = has_label)
